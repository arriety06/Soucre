package com.aurora.models.mob;

import com.aurora.consts.ConstMap;
import com.aurora.consts.ConstMob;
...
import com.aurora.models.player.Location;
import com.aurora.models.player.Pet;
...
//                MobService.gI().mobAttackPlayer(this, pl);
    ...
    public List<ItemMap> DropItemNew(Player player, int x, int yEnd) {
        ...
        int listOption[][] = {{127, 128, 129}, {130, 131, 1312}, {133, 134, 135}};
        int listParam[][] = {{139, 140, 141}, {142, 143, 144}, {145, 146, 147}};
        int randomOneToThree = Util.nextInt(2);
        if (random <= 30) { // roi skh
