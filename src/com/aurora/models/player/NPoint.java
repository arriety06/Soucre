...
//                if (this.player.inventory.itemsBody.get(5) != null){
//                    Item item = this.player.inventory.itemsBody.get(5);
//                    if (item.template.id  == 711){ // x4
//                        percentXDame = (byte)400;
//                    }
//                    if (item.template.id == 710){ /// x3
//                        percentXDame = (byte)300;
//                    }
//                }
//                }
                break;
