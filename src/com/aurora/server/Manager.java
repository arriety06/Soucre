...
import com.aurora.jdbc.daos.ShopDAO;
...
import com.aurora.models.npc.NpcFactory;
import com.aurora.models.reward.ItemMobReward;
import com.aurora.models.reward.ItemOptionMobReward;
import com.aurora.models.reward.MobReward;
import com.aurora.models.shop.Shop;
import com.aurora.models.skill.NClass;
import com.aurora.models.skill.Skill;
import com.aurora.models.task.SideTaskTemplate;
import com.aurora.models.task.SubTaskMain;
import com.aurora.models.task.TaskMain;
...
public class Manager {
    ...
    public static final List<com.aurora.models.map.Map> MAPS = new ArrayList<>();
    ...
    private void initMap() {
        ...
        for (MapTemplate mapTemp : MAP_TEMPLATES) {
            ...
            com.aurora.models.map.Map map = new com.aurora.models.map.Map(mapTemp.id,
                ...
                if (!fileEntry.isDirectory()) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        ItemMobReward item = new ItemMobReward(itemId, mapDrop,
                                ...
                                new int[]{Integer.parseInt(ratio[0]) * 50, Integer.parseInt(ratio[1])}, gender);
